...
def Home():
    st.write(f"# Welcome to Google Cloud!")
    st.write("Powered by")
...
* **Video Generation:** Witness the power of AI in creating captivating motion videos using Veo 2, to add life to products in the Meesho catalogue
